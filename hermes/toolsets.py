...
TOOLSETS = {
    ...
    "asost_translate": {
        "description": "ASOST translation tools — translate text to Arabic via the ASOST OpenRouter engine (ox-alpha)",
        "tools": ["asost_translate_text"],
        "includes": []
    },

    "asost_memory": {
        "description": "ASOST memory tools (ترجماني ميموري) — persistent key/value JSON memory for ASOST agents",
        "tools": ["asost_memory_get", "asost_memory_set"],
        "includes": []
    },
